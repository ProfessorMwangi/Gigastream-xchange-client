  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-gray-50">
      ...
      <div className="p-8 max-w-[1400px] mx-auto space-y-8">
        {/* Hero Banner */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 p-8 text-white shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-gray-200">
                    <Button
                      ...
                      className="w-full bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-4 shadow-lg"
                    >
                      {isCalculating ? (
                        <>
            ...
            {/* Quote Result */}
            {quoteResult && (
              <Card className="bg-white border-0 shadow-lg mt-6 overflow-hidden">
                ...
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-xl border border-purple-100">
                      ...
                      <p className="text-sm font-medium text-gray-600 mb-2">Total Campaign Cost</p>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-100">
                      ...
                      <p className="text-sm font-medium text-gray-600 mb-2">Estimated Reach</p>
                      <p className="text-4xl font-bold text-gray-900">
                        {(quoteResult.estimatedReach / 1000000).toFixed(1)}M
                      </p>
                      <p className="text-sm text-gray-500 mt-2">Impressions per month</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6 bg-gray-50 rounded-xl">
                    <div className="flex items-center gap-3">
                      <div className="p-2 bg-blue-100 rounded-lg">
                        <BillboardIcon className="w-5 h-5 text-blue-600" />
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Available Sites</p>
                        <p className="text-lg font-bold text-gray-900">{quoteResult.availableSites}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900">{duration} Month{duration !== '1' ? 's' : ''}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-500">CPM (Cost per 1K)</p>
            ...
            <Card className="bg-white border-0 shadow-lg">
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {locations.map((loc) => (
                    <div key={loc.value} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200 shadow-lg">
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-purple-900">Pricing Benefits</h4>
                </div>
            ...
            <Card className="bg-white border-0 shadow-lg">
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-gray-900">Average Rates</h4>
                </div>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600">LED Digital</span>
                      <span className="text-sm font-bold text-gray-900">KES 450K/month</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600">Premium LED</span>
                      <span className="text-sm font-bold text-gray-900">KES 650K/month</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
